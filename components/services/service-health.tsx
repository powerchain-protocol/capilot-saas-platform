...
import type { ServiceHealth as ServiceHealthType } from "@/apps/frontend/api/v1";
...
export function ServiceHealth() {
  ...
  async function load() {
    ...
    try { setServices(await apiV1.getServices()); }

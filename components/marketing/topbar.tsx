...
export function Topbar() {
  ...
  return (
    <div className="relative border-b border-[#E1E6E2] bg-[#F4F6F4] px-12">
      <div className="mx-auto flex min-h-9 max-w-5xl items-center justify-center gap-2 text-center text-[10px] font-semibold text-[#5D6961] sm:text-[11px]">
        <span className="rounded-full border border-[#D7E3DA] bg-white px-2 py-0.5 text-[8px] font-extrabold tracking-[.12em] text-[#1E6B4B]">{topbarConfig.badge}</span>

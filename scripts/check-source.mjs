...
const required = [
  ...
  "apps/frontend/hooks/use-api-generator.ts",
  "apps/frontend/hooks/use-credits.ts",
  "apps/frontend/types/credits.ts",
  "apps/frontend/credits/index.ts",
  "apps/frontend/tokens/pwrc.ts",
  "apps/frontend/generators/api/generated.ts",

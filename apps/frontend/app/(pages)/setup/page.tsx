      ...
      <main className="bg-[var(--canvas)] py-14 sm:py-20">
        <div className="pc-shell">
          <div className="mx-auto mb-9 max-w-3xl text-center sm:mb-12">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-[var(--muted)]">Choose a platform and trusted distribution source. GitHub Releases, Google Drive, managed stores, and the web app are routed through one canonical setup flow.</p>
          </div>
